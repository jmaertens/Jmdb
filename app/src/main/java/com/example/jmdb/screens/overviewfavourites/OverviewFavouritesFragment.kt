 ...
 * Use the [OverviewFavouritesFragment.newInstance] factory method to
...
class OverviewFavouritesFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment OverviewFavouritesFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            OverviewFavouritesFragment().apply {
